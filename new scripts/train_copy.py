...
def parse_args():
    ...
    parser.add_argument("--model_save_dir", type=str, default="models", help="directory to save models") # adding new argument to specify model save dir
...
def train_one_epoch(args, model, optimizer, train_loader, epoch, criterion):
    ...
    for batch, batched_input in enumerate(train_loader):
            ...
            if int(batch+1) % 200 == 0:
                ...
                save_path = os.path.join(args.model_save_dir, args.run_name, f"epoch{epoch+1}_batch{batch+1}_sam.pth")
...
def main(args):
    ...
    for epoch in range(0, args.epochs):
        ...
        if average_loss < best_loss:
            ...
            os.makedirs(os.path.join(args.model_save_dir, args.run_name), exist_ok=True) # adding code - check for dir
            save_path = os.path.join(args.model_save_dir, args.run_name, f"epoch{epoch+1}_sam.pth") # changing save path
...
if __name__ == '__main__':
    ...
    # args.data_path = "bk_bm_data/train"
    # args.run_name = "sammed_BM_encoder"
    # args.batch_size = 8
    # args.epochs = 8
    # --------------------------------------------------
    # Splitting by patient
    args.work_dir = "/home/vivian/SAM_Med2D"
    # args.data_path = "patient_split/rfbm_data/train"
    # args.data_path = "RF_v2/train"
    args.data_path = 'patient_split/all_USmod_data/train'
    args.run_name = "all_USmod_patient_en"  # change path where the model is saved to /DATA dir 
    args.batch_size = 8
    args.epochs = 10
    args.model_save_dir = '/DATA/vivian/models'
